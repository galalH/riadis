...
preview: images/macro/MACRO_1_SQ_SPA.jpg
twitter:
  site: "@unhcr"
  creator: "@unhcr"
output: 
...
meta() %>%
  meta_social(
    ...
    image = "https://unhcr-americas.github.io/riadis/docs/images/para/header.jpg",
...
<aside>Un total de 744 personas con discapacidad, familiares y/o personas de apoyo y actores gubernamentales y humanitarios fueron consultados en siete países de América Latina, a través de entrevistas, grupos focales, historias de vida y una encuesta regional en línea.</aside>
...
<iframe width="415" height="415" src="https://www.youtube.com/embed/r4hAttRywys?controls=0&autoplay=1&playlist=r4hAttRywys&loop=1&modestbranding=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
```{r, layout="l-page"}
include_graphics("images/macro/MACRO_1_SQ_SPA.jpg")
```
