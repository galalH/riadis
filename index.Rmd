...
preview: images/para/header.jpg
twitter:
  site: "@unhcr"
  creator: "@unhcr"
output: 
...
meta() %>%
  meta_social(
    title = "Discapacidad y Movilidad Humana",
    description = "Por la inclusión de las personas con discapacidad en situación de movilidad humana en las Américas",
    url = "https://disabilitiesonthemove.org",
    image = "https://disabilitiesonthemove.org/images/para/header.jpg",
    image_alt = "Discapacidad y Movilidad Humana",
    og_type = "website",
    og_author = "ACNUR",
...
<aside style="grid-row: span 3; margin-bottom: 120px">Un total de 744 personas con discapacidad, familiares y/o personas de apoyo y actores gubernamentales y humanitarios fueron consultados en siete países de América Latina, a través de entrevistas, grupos focales, historias de vida y una encuesta regional en línea.</aside>
...
Este estudio regional fue realizado por organizaciones de personas con discapacidad, liderado por la [Red Latinoamericana de Organizaciones No Gubernamentales de Personas con Discapacidad y sus Familias (RIADIS)](http://www.riadis.org/) y elaborado conjuntamente con la [Coalición México por los Derechos de las Personas con Discapacidad (COAMEX)](https://coalicionmexico.org.mx), México; [la Sociedad y Discapacidad (SODIS)](https://sodisperu.org/), Perú; y [Humanity&Inclusion (HI)](https://hi.org/en/index), Colombia; con el apoyo de la [Agencia de la ONU para los Refugiados (ACNUR)](https://www.acnur.org/). _Discapacidad y Movilidad Humana_, responde a los compromisos de ACNUR en promover respuestas integrales y fortalecer la participación de las personas con discapacidad en situación de desplazamiento forzado, asegurando su protección, integración y la búsqueda de soluciones.

<iframe width="415" height="415" src="https://www.youtube.com/embed/XEuaao-MC4E" title="YouTube video player" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> "(…) el ocho de octubre miembros de las pandillas atacaron, matando (…) al abuelo de mis hijos.  Mi niño, el mayor, vio cómo lo iban siguiendo y uno de los pandilleros ...se acercó con un arma, amenazándole y diciéndole que si él comentaba algo de lo que había visto, lo iban a matar…"
> (Entrevista mujer con discapacidad salvadoreña en México, 2020).
...
<aside style="grid-column: span 2; grid-row: span 2; margin-bottom: 150px;">
...
<aside style="grid-column: span 2; grid-row: span 2; margin-bottom: 100px">El **40.2%** de las personas con discapacidad consultadas indican que sí **han enfrentado situaciones de riesgo** durante su desplazamiento.</aside>
...
```{r, layout="l-page"}
include_graphics("images/macro/MACRO_5_TW_SPA.jpg")
```
...
> He estado buscando trabajo y no he podido encontrar. Por una parte por la pandemia. Y otra, por mi discapacidad. La empresa como que no me dan prioridad. Entonces sí le estoy batallando.  Vamos a seguir buscando, porque no queda de otra."
> (Entrevista hombre con discapacidad hondureño y mexicano por naturalización en México, 2020)

<aside style="margin-bottom: 50px;">El 66% de las personas encuestadas menciona que no recibió asistencia humanitaria</aside>
...
<img src="images/macro/story.jpg" width="100%" height="auto"/>

> "Fue muy difícil porque apenas habían pasado cuatro meses desde la amputación", recordó Manuel.  

[...¡Lee la historia completa aquí! ](https://www.acnur.org/noticias/briefing/2021/7/60f88a5d4/la-vida-es-una-ardua-batalla-para-las-personas-desplazadas-con-discapacidad.html)

</div>

## El impacto de la COVID-19 en las personas con discapacidad en situación de movilidad en las Américas
...
<aside style="grid-column: span 2; grid-row: span 2; margin-bottom: 20px;">Para algunas de las personas con discapacidad con enfermedades crónicas o con familiares/personas de apoyo con enfermedades crónicas, ven aún más limitada su capacidad de movilidad lo que conlleva a un nivel mayor de dependencia hacia terceros.</aside>
...
## Organizaciones Aliadas {.appendix}

[![COAMEX](images/logos/COAMEX.png)](https://coalicionmexico.org.mx/) [![HI](images/logos/HI.png)](https://hi.org/) [![SODIS](images/logos/SODIS.png)](https://sodisperu.org/)
